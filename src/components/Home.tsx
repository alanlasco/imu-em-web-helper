      ...
      <div className="HomeContaier">
        ...
        <div className="CardContainerHome">
          <div className="welcomeContainer">
            ...
            <strong className="Em">
              🏹Event Master's Web Tool<span className="bow">🏹</span>{" "}
            </strong>
          </div>
          ...
          <ul className="list">
            ...
            <br />
            <li className="listE">Atomic Number of the element</li>
            <li className="listE">Chemical Symbol of the element</li>
            <li className="listE">Math</li>
            <li className="listE">Capitals and countries</li>
            <li className="listE">Countries and Continents</li>
            <li className="listE">Map of The Mobs</li>
            <br />
          ...
          <p>Each feature will generate a Random list</p>
